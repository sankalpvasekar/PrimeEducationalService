...
export default function PreparationAdminPage() {
  ...
  const handleUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      await fetch('/api/admin/config', {
        ...
        body: JSON.stringify({ preparation_pdfs: newPdfs })
      });
  ...
  return (
    <div className="p-10 space-y-6">
      <h1 className="text-2xl font-bold">Manage Preparation Material PDFs</h1>
      ...
      <div className="p-6 bg-white border rounded-3xl space-y-4">
        ...
        <button className="bg-[#C5A059] text-white px-6 py-3 rounded-xl font-bold flex items-center gap-2">
